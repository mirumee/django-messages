...
class SendTestCase(TestCase):
    def setUp(self):
        self.user1 = get_user_model().objects.create_user('user1', 'user1@example.com', '123456')
        self.user2 = get_user_model().objects.create_user('user2', 'user2@example.com', '123456')
...
class DeleteTestCase(TestCase):
    def setUp(self):
        self.user1 = get_user_model().objects.create_user('user3', 'user3@example.com', '123456')
        self.user2 = get_user_model().objects.create_user('user4', 'user4@example.com', '123456')
